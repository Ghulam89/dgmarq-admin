    ...
    <div className=" bg-no-repeat bg-cover h-screen flex justify-center items-center">
      <div className="bg-white bg-opacity-85 w-full h-full flex justify-center items-center">
        <form
          ...
          className="shadow-2xl bg-black p-5 w-10/12 sm:w-8/12 md:w-6/12 lg:w-4/12 flex flex-col gap-5 rounded-lg"
        >
          <div className="text-center">
          
            <img src={require('../../assets/image/admin-logo.jpeg')} className=" w-56 mx-auto" alt="" />
